  ...
  return (
    <SheetPortal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out duration-300",
          sideVariants[side],
          className
        )}
        {...props}>
